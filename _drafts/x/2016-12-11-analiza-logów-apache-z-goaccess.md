...
{% include video.html url='https://www.dropbox.com/s/zdw2vagywhqw9sz/5.ogv?dl=1' %}

## Instalcja

GoAcces jest przystosowany do działania na wielu systemach z różnymi rodzajami logów.
W tym wpisie robię założenie, że, mamy dystrybucję z repozytoriami Debiana/Ubuntu, serwer Apache2. W tym przypadku do [instalacji GoAccess](https://goaccess.io/download) posłużą nam komendy:
