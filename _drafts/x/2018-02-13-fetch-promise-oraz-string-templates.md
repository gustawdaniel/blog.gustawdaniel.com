...
Widać tutaj, że na większych urządzeniach chcę mieć margines, który na mniejszych nie jest już potrzebny.
...
Jenak `Promise` to nie jedyna ciekawa rzecz, którą można dostrzec w tych kilku liniach.
